"""
Django settings for d_tiaozao project.
...
SECRET_KEY = ')$f@bn+nr7f+(nnu1kk54djh2g9(@4onbm4%!gz#)c_vxteo0z'
...
WSGI_APPLICATION = 'd_tiaozao.wsgi.application'
